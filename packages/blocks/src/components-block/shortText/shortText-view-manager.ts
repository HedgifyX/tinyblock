...
type ShortTextViewData = RealDataViewDataTypeMapForComponents['shortText'];

export class DataViewShortTextManager extends BaseDataViewManagerForComponents {
  public override get type(): string {
    return this.view.mode;
  }

  private readonly updateView: (
    updater: (view: ShortTextViewData) => Partial<ShortTextViewData>
  ) => void;

  constructor(
    private viewSource: SingleViewSourceForComponents<ShortTextViewData>,

...
type LongTextViewData = RealDataViewDataTypeMapForComponents['longText'];

export class DataViewLongTextManager extends BaseDataViewManagerForComponents {
  public override get type(): string {
    return this.view.mode;
  }

  private readonly updateView: (
    updater: (view: LongTextViewData) => Partial<LongTextViewData>
  ) => void;

  constructor(
    private viewSource: SingleViewSourceForComponents<LongTextViewData>,

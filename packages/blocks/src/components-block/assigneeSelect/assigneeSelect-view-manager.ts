...
type AssigneeSelectViewData =
  RealDataViewDataTypeMapForComponents['assigneeSelect'];

export class DataViewAssigneeSelectManager extends BaseDataViewManagerForComponents {
  public override get type(): string {
    return this.view.mode;
  }

  private readonly updateView: (
    updater: (view: AssigneeSelectViewData) => Partial<AssigneeSelectViewData>
  ) => void;

  constructor(
    private viewSource: SingleViewSourceForComponents<AssigneeSelectViewData>,
